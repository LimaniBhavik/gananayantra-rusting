...
pub fn calculate_volumetric_weight(length: f64, width: f64, height: f64, divisor: f64) -> Result<f64, String> {
...
mod tests {
    ...
    fn test_volumetric_weight() {
        ...
        assert_eq!(calculate_volumetric_weight(50.0, 40.0, 30.0, 5000.0).unwrap(), 12.0);
    }
}
